...
<template>
    <div class="mt-[10px] p-4">
        <div class="dashboard-content h-screen flex justify-center items-center">
            <div class="relative bg-white p-5 py-10 sm:rounded-3xl sm:px-5">
                <div class="flex">
                    <svg class="h-14 w-14 flex-none" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#0EA5E9"
                        stroke-width="1.5">
                        <path
                    ...
                    <div class="ml-4">
                        <h2 class="text-base font-semibold leading-7 text-slate-900">Personal</h2>
                        <p class="text-sm leading-6 text-slate-700">For individuals working on their next big idea.</p>
                    </div>
                </div>
                <div class="relative -mx-5 mt-8 ring-1 ring-slate-900/5 sm:mx-0 sm:rounded-2xl">
                    ...
                    <div class="relative flex flex-col bg-slate-50 py-8 px-5 sm:rounded-2xl">
                        <p class="flex items-center justify-center"><span
                                class="text-[2.5rem] leading-none text-slate-900">IDR. <span
                                    class="font-bold">15.000,00</span></span><span class="ml-3 text-sm"><span
                                    class="font-semibold text-slate-900">one-time payment</span><br><span
                        ...
                        <p class="order-last -mx-1 mt-4 flex justify-center text-sm leading-6 text-slate-500 sm:space-x-2">
                            <span class="hidden sm:inline">Lifetime access.</span><span class="hidden sm:inline">Unlimited
                                projects.</span><span class="hidden sm:inline">Free updates.</span><span
                        ...
                        <a v-if="!payment?.data?.invoice_url" @click.prevent="handlePayment"
                            class="inline-flex justify-center rounded-lg text-sm font-semibold py-2 px-3 bg-red-500 text-white hover:bg-red-700 mt-6 w-full"
                            href="">
                            <span>Get Premium
                            </span>
                        </a>
                ...
                <ul class="mt-8 space-y-8 text-sm leading-6 text-slate-700">
                    <li class="flex"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 32 32"
                        ...
                        <p class="ml-6"><strong class="font-semibold text-slate-900">Over 500+ components</strong> —
                            everything you need to build beautiful application UIs, marketing sites, ecommerce stores, and
                            more.</p>
                    </li>
                    <li class="flex"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 32 32"
                            class="h-8 w-8 flex-none">
                            <path fill="#fff" d="M0 0h32v32H0z"></path>
                            <rect width="23" height="22" x="3" y="5" stroke="#0EA5E9" stroke-linejoin="round"
                                stroke-width="1.5" rx="2"></rect>
                            <rect width="10" height="18" x="19" y="9" fill="#E0F2FE" stroke="#0EA5E9"
                        ...
                        <p class="ml-6"><strong class="font-semibold text-slate-900">Every site template</strong> —
                            beautifully designed, expertly crafted website templates built with modern technologies like
                            React and Next.js.</p>
                    </li>
                    <li class="flex"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 32 32"
                            class="h-8 w-8 flex-none">
