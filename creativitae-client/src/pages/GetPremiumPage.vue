...
export default {
    computed: {
        ...mapState(useMainStore, ['payment', 'isPremium'])
    },
    methods: {
...
<template>
    <div class="mt-[10px] p-4">
        <div class="dashboard-content h-screen flex justify-center items-center">
            <div class="relative bg-white p-5 py-10 mx-[400px] sm:rounded-3xl sm:px-5">
                <div class="flex">
                    <svg class="h-14 w-14 flex-none" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#dc2625"
                        stroke-width="1.5">
                        <path
                    ...
                    <div class="ml-4">
                        <h2 class="text-base font-semibold leading-7 text-slate-900">Premium Membership</h2>
                        <p class="text-sm leading-6 text-slate-700">For making your CV more attractive.</p>
                    </div>
                </div>
